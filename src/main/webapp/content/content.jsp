...
<body>
	...
	<div class="container">
		<div class="row">
			<!--左边板块-->
			<div id="content_left" class="col-xs-3 col-md-1 bottom_left">
				<div style="position: relative; padding-top: 10px;text-align: center;">
					<ul >
						<li style="height:32px;line-height: 32px;"><b>所有板块</b></li>
						<hr class="hr_style">
					<!-- 所有板块-开始循环 -->
					<c:forEach var="plate" items="${plate }" varStatus="status" >
						<li style="height:32px;line-height: 32px;">
							<a href="${APP_PATH }/common/getArticleBname?bname=${plate.bname }" class="a_sty"> 
								${plate.bname }
							</a>
						</li>
					</c:forEach>
			...
			<!--中间板块-->
			<div id="content_mid" class="col-xs-7 col-md-7 bottom_mid">
				<!--代码部分begin-->
				<div class="jq22">
					<div class="hidden">
						<!--此处进行循环展示-->
													...
													<form action="${APP_PATH }/commentController/setComment">
														<div class="col-xs-10 col-md-11">
															...
															<input type="text" class="form-control"
																 name="pcontent" placeholder="写下你的评论..." required>
														</div>
														<div class="col-xs-2 col-md-1">
			...
			<!-- 右边模块 -->
			<div id="content_right" class="col-xs-2 col-md-4 bottom_right">
				<div style="position: relative; padding-top: 10px;padding-bottom: 10px;" >
						<b style="height:32px;line-height: 32px;font-size: 15px">热门文章</b>
						<hr class="hr_style">
				</div>
				<!-- 只显示通过审核的帖子且评论数大于1文章 -->
				<div>
					...
					<c:if test="${listArticle.status==1 && listArticle.sum>1 }">
						...
						<div class="media">
		  					<div class="media-left">
								<img class="media-object" src="${APP_PATH}/static/img/head.png" alt="" style="width:54px;height: 38px;">
							</div>
							<div class="media-body">
		    					<h5 class="media-heading"><a href="${APP_PATH }/articleController/getArticleFid?fid=${listArticle.fid }">${listArticle.titles }</a></h5>
